            ...
            <div className="flex min-h-screen bg-gray-50">
              ...
              <NavLink
                                                                ...
                                                                >
                                                                    ...
                                                                    <div
                                                                        className={`p-2 rounded-lg transition-all duration-300 ${isActive("/storage-units") ? "bg-blue-500/40 shadow-lg" : "group-hover:bg-blue-700/50"}`}
                                                                    >
                                                                        <Truck
                                                                            size={18}
                                                                            className={`transition-all duration-300 ${isActive("/storage-units") ? "text-blue-100" : "text-blue-300 group-hover:text-blue-100"}`}
                                                                        />
                                                                    </div>
                                                                    <div className="flex-1 relative z-10">
                                                                        <span className="font-semibold">Danh sách kho</span>
                                                                    </div>
                                                                    {isActive("/storage-units") && (
                                                                        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-1 h-8 bg-gradient-to-b from-blue-300 via-blue-200 to-blue-300 rounded-l-full shadow-lg"></div>
                                                                    )}
                                                                </NavLink>
                            <NavLink
