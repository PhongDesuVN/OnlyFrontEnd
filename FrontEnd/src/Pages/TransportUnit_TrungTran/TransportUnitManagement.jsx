...
export default function TransportUnitManagement() {
    ...
    return (
        <div
     className="bg-white/80 backdrop-blur-sm rounded-xl shadow-xl border border-blue-100 flex flex-col flex-grow overflow-hidden ml-4 mt-[10px]">
            {/* NỘI DUNG CHÍNH */}
            <main className="flex-grow flex flex-col pt-5 px-4 overflow-hidden ">
                ...
                {/* ===== COMPACT LIST CARD ===== */}
                <div
                    className="bg-white/80 backdrop-blur-sm rounded-xl shadow-xl border border-blue-100 flex flex-col flex-grow overflow-hidden ml-4 mt-[10px] h-[calc(96vh-186px)]">
                    ...
                    {/* TABLE CONTAINER */}
                    <div className="flex-1 flex flex-col overflow-hidden h-full"> {/* <-- THAY ĐỔI CẦN THIẾT */}
                        {loading ? (
