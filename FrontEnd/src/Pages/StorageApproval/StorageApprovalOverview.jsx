    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-1">
        <SidebarStorageApproval
          overview={{ totalPending, totalApproved, totalRejected, totalProcessed }}
        ...
        <main className="flex-1 ml-64 pt-20 pb-16 px-6">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-800 to-blue-600 bg-clip-text text-transparent mb-8">
            Tổng Quan Duyệt Kho Lưu Trữ
          </h1>
          <button
            className="mb-6 px-6 py-2 bg-blue-600 text-white rounded-lg font-semibold shadow hover:bg-blue-700 transition"
